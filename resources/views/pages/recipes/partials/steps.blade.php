...
<div>
    <h2 class="text-3xl font-semibold py-2">INSTRUCTIONS</h2>

    {{-- Intro text (SHOW ONCE) --}}
    <div class="text-sm mb-4">
        <p>
            This recipe goes beyond the basics, inviting you to savor the richness of a creamy
            ...
            is as comforting as it is delightful.
        </p>

        <p class="py-4">
            Allow the chicken to rest for 10 minutes before carving.
            This brief resting period is essential; it allows the juices to redistribute,
            ensuring each slice is succulent and bursting with flavor.
